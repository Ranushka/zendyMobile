...
class ProductModel {
  ...
  List<ProductModelColor> productColors;
  ...
  factory ProductModel.fromJson(Map<String, dynamic> json) => ProductModel(
        ...
        productColors: List<ProductModelColor>.from(
            json["product_colors"].map((x) => ProductModelColor.fromJson(x))),
      );
...
class ProductModelColor {
  ...
  factory ProductModelColor.fromJson(Map<String, dynamic> json) =>
      ProductModelColor(
